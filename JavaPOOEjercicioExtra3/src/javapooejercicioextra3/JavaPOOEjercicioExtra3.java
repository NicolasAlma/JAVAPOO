...
public class JavaPOOEjercicioExtra3 {
    ...
    public static void main(String[] args) {
        //Se asignan las funciones de la clase a una variable auxiliar
        servicioRaices AU = new servicioRaices();
        //Se instancia la clase ecuacion y se le asignan las funciones de la varible antes creada
        Raices ecu = AU.asignar();
        //Se llama al metodo Calcular para que calcule la ecuacion antes ingresada
        System.out.println("-------------------------");
        AU.calcular(ecu);
    }
