 ...
 * @author tu
 */
public class JavaPOOEjercicio13 {
    ...
    public static void main(String[] args) {
        ...
        servicioCurso AU = new servicioCurso();
        //Se instancia la persona con la clase persona y se le asigna las funciones del objeto antes creado
        Curso C1 = AU.crearCurso();
        System.out.println("---------------------------------------");
        //Se muestra la ganancia semanal
        AU.calcularGananciaSemanal(C1);
    }
